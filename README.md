...
Добро пожаловать! Этот проект представляет собой Telegram‑бота, работающего в Docker‑контейнере. Ниже — полностью оформленная, удобная и структурированная инструкция по установке и запуску.
